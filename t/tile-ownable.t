...
my $price = 100;
my $tile = Games::Opoly::Board::Tile::Ownable->new( price => $price, name => 'Test Tile', group => $group, address => 1 );
my $action_tile = Games::Opoly::Board::Tile::Ownable->new( price => $price, name => 'Test Tile', group => $group, address => 2 );
